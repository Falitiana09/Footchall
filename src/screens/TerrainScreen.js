...
const TerrainScreen = ({ navigation }) => {
  const [niveaux, setNiveaux] = useState([
    { id: 1, nom: "Niveau 1", debloque: true, score: null, questions: 20 },
    { id: 2, nom: "Niveau 2", debloque: false, score: null, questions: 20 },
    { id: 3, nom: "Niveau 3", debloque: false, score: null, questions: 20 },
    { id: 4, nom: "Niveau 4", debloque: false, score: null, questions: 20 },
    { id: 5, nom: "Niveau 5", debloque: false, score: null, questions: 20 },
    { id: 6, nom: "Niveau 6", debloque: false, score: null, questions: 20 },
    { id: 7, nom: "Niveau 7", debloque: false, score: null, questions: 20 },
    { id: 8, nom: "Niveau 8", debloque: false, score: null, questions: 20 },
    { id: 9, nom: "Niveau 9", debloque: false, score: null, questions: 20 },
    { id: 10, nom: "Niveau 10", debloque: false, score: null, questions: 20 }
  ]);
  ...
  const demarrerNiveau = (niveau) => {
    ...
    navigation.navigate('QuizTerrain', { 
      niveau: niveau,
  ...
  const getStatusNiveau = (niveau) => {
    ...
    if (niveau.score === null) {
      return { text: "📝 Commencer", color: "#1e90ff", bgColor: "#e3f2fd" };
    }
    if (niveau.score >= 15) {
  ...
  return (
    <ImageBackground 
      source={require('../../assets/images/terrain_bg.jpeg')}
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Deviner le Terrain</Text>
          <Text style={styles.subtitle}>Reconnaissez les stades de football célèbres</Text>
        </View>
