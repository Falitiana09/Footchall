...
const LogoScreen = ({ navigation }) => {
  const [niveaux, setNiveaux] = useState([
    { id: 1, nom: "Niveau 1 - Clubs européens", debloque: true, score: null, questions: 10 },
    { id: 2, nom: "Niveau 2 - Clubs anglais", debloque: false, score: null, questions: 10 },
    { id: 3, nom: "Niveau 3 - Clubs espagnols", debloque: false, score: null, questions: 10 },
    { id: 4, nom: "Niveau 4 - Clubs italiens", debloque: false, score: null, questions: 10 },
    { id: 5, nom: "Niveau 5 - Clubs allemands", debloque: false, score: null, questions: 10 },
    { id: 6, nom: "Niveau 6 - Clubs français", debloque: false, score: null, questions: 10 },
    { id: 7, nom: "Niveau 7 - Clubs sud-américains", debloque: false, score: null, questions: 10 },
    { id: 8, nom: "Niveau 8 - Clubs asiatiques", debloque: false, score: null, questions: 10 },
    { id: 9, nom: "Niveau 9 - Clubs africains", debloque: false, score: null, questions: 10 },
    { id: 10, nom: "Niveau 10 - Clubs historiques", debloque: false, score: null, questions: 10 }
  ]);
  ...
  const getStatusNiveau = (niveau) => {
    ...
    if (niveau.score === null) {
      return { text: "📝 Commencer", color: "#ffa500", bgColor: "#fff3cd" };
    }
    if (niveau.score >= 15) {
  ...
  return (
    <ImageBackground 
      source={require('../../assets/images/logo_bg.jpeg')}
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Logo de Club</Text>
          <Text style={styles.subtitle}>Identifiez les logos des clubs de football</Text>
        </View>
