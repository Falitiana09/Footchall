...
const JouerScreen = ({ navigation }) => {
  const [niveaux, setNiveaux] = useState([
    { id: 1, nom: "Niveau 1 - Débutant", debloque: true, score: null, questions: 10 },
    { id: 2, nom: "Niveau 2 - Amateur", debloque: false, score: null, questions: 10 },
    { id: 3, nom: "Niveau 3 - Intermédiaire", debloque: false, score: null, questions: 10 },
    { id: 4, nom: "Niveau 4 - Avancé", debloque: false, score: null, questions: 10 },
    { id: 5, nom: "Niveau 5 - Expert", debloque: false, score: null, questions: 10 },
    { id: 6, nom: "Niveau 6 - Légendes", debloque: false, score: null, questions: 10 },
    { id: 7, nom: "Niveau 7 - Stars actuelles", debloque: false, score: null, questions: 10 },
    { id: 8, nom: "Niveau 8 - Talents émergents", debloque: false, score: null, questions: 10 },
    { id: 9, nom: "Niveau 9 - Champions", debloque: false, score: null, questions: 10 },
    { id: 10, nom: "Niveau 10 - Maître", debloque: false, score: null, questions: 10 }
  ]);
  ...
  const demarrerNiveau = (niveau) => {
    ...
    navigation.navigate('QuizJoueur', { 
      niveau: niveau,
  ...
  const getStatusNiveau = (niveau) => {
    ...
    if (niveau.score === null) {
      return { text: "📝 Commencer", color: "#ff6b6b", bgColor: "#ffeaea" };
    }
    if (niveau.score >= 15) {
  ...
  return (
    <ImageBackground 
      source={require('../../assets/images/joueur_bg.jpeg')}
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Deviner le Joueur</Text>
          <Text style={styles.subtitle}>Reconnaissez les joueurs de football célèbres</Text>
        </View>
